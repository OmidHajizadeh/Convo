...
sw.addEventListener("push", function (event) { return __awaiter(_this, void 0, void 0, function () {
    var message, isWindowOpen;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, checkClientIsVisible()];
            case 1:
